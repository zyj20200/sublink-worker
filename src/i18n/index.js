...
export const translations = {
  'zh-CN': {
    ...
    addSource: '添加来源',
    sourceName: '来源名称',
    sourceNamePlaceholder: '例如：我的机场',
    sourceContent: '订阅链接或节点',
    ...
    customRuleUrl: '规则集URL',
    customRuleUrlTooltip: '支持GitHub Raw链接的Clash规则集（.yaml/.list/.txt），仅对Clash配置生效。例如 blackmatrix7/ios_rule_script 仓库中的规则',
    customRuleUrlPlaceholder: '例如：https://raw.githubusercontent.com/.../Emby.yaml 或 .list',
    ...
    useProvider: '订阅链接引用模式',
    useProviderTip: '不解析节点，直接将订阅链接写入配置文件，由客户端本地拉取解析（Clash/SingBox 1.12+）',
  ...
  'en-US': {
    ...
    customRuleUrl: 'Rule Set URL',
    customRuleUrlTooltip: 'Supports GitHub Raw link rule sets (.yaml/.list/.txt). Only applies to Clash configs. E.g., rules from blackmatrix7/ios_rule_script',
    customRuleUrlPlaceholder: 'e.g., https://raw.githubusercontent.com/.../Emby.yaml or .list',
    ...
    useProvider: 'Subscription Provider Mode',
    useProviderTip: 'Use subscription URLs as proxy-providers directly instead of parsing nodes. Client fetches & parses locally (Clash/SingBox 1.12+)',
  ...
  'fa': {
    ...
    customRuleUrl: 'آدرس مجموعه قوانین',
    customRuleUrlTooltip: 'پشتیبانی از لینک‌های GitHub Raw (.yaml/.list/.txt). فقط برای پیکربندی Clash اعمال می‌شود',
    customRuleUrlPlaceholder: 'مثال: https://raw.githubusercontent.com/.../Emby.yaml یا .list',
    ...
    useProvider: 'حالت ارائه‌دهنده اشتراک',
    useProviderTip: 'لینک‌های اشتراک را مستقیماً به عنوان proxy-provider استفاده کنید (Clash/SingBox 1.12+)',
  ...
  'ru': {
    ...
    customRuleUrl: 'URL набора правил',
    customRuleUrlTooltip: 'Поддержка ссылок GitHub Raw (.yaml/.list/.txt). Применяется только к конфигурации Clash',
    customRuleUrlPlaceholder: 'например: https://raw.githubusercontent.com/.../Emby.yaml или .list',
    ...
    useProvider: 'Режим провайдера подписки',
    useProviderTip: 'Использовать URL подписки как proxy-provider напрямую, без разбора узлов (Clash/SingBox 1.12+)',
